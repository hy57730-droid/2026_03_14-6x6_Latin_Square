...
You may use, modify, and distribute this software for personal or educational purposes, but commercial use is strictly prohibited.
...
### 📜 ライセンス
個人利用・非商用利用目的に限定  
本プロジェクトは 個人および非商用での利用 を目的としています。  
個人利用または教育目的であれば、本ソフトウェアの使用、改変、配布が可能です。
商用目的の利用はお控えください。
